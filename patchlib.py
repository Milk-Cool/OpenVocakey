...
for target in "esp32dev", "cardputer":
    PATH_A = join(".pio", "libdeps", target, "BackgroundAudio", "src", "BackgroundAudioSpeech.h")
    PATH_B = join(".pio", "libdeps", target, "BackgroundAudio", "src", "libespeak-ng", "synthesize.h")
